...
import com.djtu.fywz.dao.OrderItemMapper;
...
public class OrderItemServiceImpl implements OrderItemService {
    ...
    public void fill(Order o) {
        ...
        setProduct(ois);//现在当前订单的每个订单项都有宠物属性
    ...
    @Override
    public List<Statistical> selectStatistical(OrderItem oi) {
        return orderItemMapper.selectStatistical(oi);
    }
